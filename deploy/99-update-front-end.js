...
async function updateAbi() {
    ...
    fs.writeFileSync(FRONT_END_ABI, myContract.interface.format(ethers.utils.FormatTypes.json))
}
...
async function updateContractAddresses() {
    ...
    const currentAddresses = JSON.parse(fs.readFileSync(FRONT_END_ADDRESSES, "utf8"))
